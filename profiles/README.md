...
| domena5-prod | pending | domena-5@agregat-streszczen.pl (do potwierdzenia dumpem) | — (plan: `domena5-prod-signedin.tar.gz` po loginie) | SEEDED 2026-09-12 from `test` (docker `cp -a`, uid-perfect); kontener `use`-owany, menu profilu otwarte — OPERATOR login PENDING (variant-direct, docs/profile-provisioning-mobile.md) |
| domena6-prod | pending | domena-6@agregat-streszczen.pl (tbp) | — | SEEDED 2026-09-12 from `test`; login PENDING (kolejny po d5) |
| domena7-prod | pending | domena-7@agregat-streszczen.pl (tbp) | — | SEEDED 2026-09-12 from `test`; login PENDING |
| domena8-prod | pending | domena-8@agregat-streszczen.pl (tbp) | — | SEEDED 2026-09-12 from `test`; login PENDING |
